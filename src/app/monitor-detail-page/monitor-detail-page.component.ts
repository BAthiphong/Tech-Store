...
import { Product } from './monitor.models';
...
@Component({
  ...
  templateUrl: './monitor-detail-page.component.html',
  styleUrl: './monitor-detail-page.component.css'
})
export class MonitorDetailPageComponent {
  images: any[] = [];
