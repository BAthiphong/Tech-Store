...
import { Product } from './ram-detail.models';
import { CartService } from '../services/cart.service';

@Component({
  selector: 'app-ram-detail-page',
  standalone: true,
  imports: [
    NavbarComponent,
    GalleriaModule,
  ...
  templateUrl: './ram-detail-page.component.html',
  styleUrl: './ram-detail-page.component.css',
})
export class RamDetailPageComponent {
  images: any[] = [];
