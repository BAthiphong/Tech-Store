...
@Component({
  ...
  templateUrl: './cpu-detail-page.component.html',
  styleUrl: './cpu-detail-page.component.css',
})
export class CpuDetailPageComponent {
  images: any[] = [];
