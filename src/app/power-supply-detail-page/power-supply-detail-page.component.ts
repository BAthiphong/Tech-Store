...
import { Product } from './power-supply.models';
import { CartService } from '../services/cart.service';

@Component({
  selector: 'app-power-supply-detail-page',
  standalone: true,
  imports: [
    NavbarComponent,
    GalleriaModule,
  ...
  templateUrl: './power-supply-detail-page.component.html',
  styleUrl: './power-supply-detail-page.component.css',
})
export class PowerSupplyDetailPageComponent {
  images: any[] = [];
