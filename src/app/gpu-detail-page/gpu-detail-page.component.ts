...
import { Product } from './gpu-detail.models';
import { CartService } from '../services/cart.service';

@Component({
  selector: 'app-gpu-detail-page',
  standalone: true,
  imports: [
    NavbarComponent,
    GalleriaModule,
  ...
  templateUrl: './gpu-detail-page.component.html',
  styleUrl: './gpu-detail-page.component.css',
})
export class GpuDetailPageComponent {
  images: any[] = [];
  ...
  product: Product = {
    ...
    quantity: 0,
    images: [],
    type: '', // หรือกำหนดค่า type ตามที่ UpdateProductDto ต้องการ
    details: {
      brands: '',
      warranty: '',
      dimension: '',
