...
import { Product } from './mainboard-detail.model';
import { CartService } from '../services/cart.service';

@Component({
  selector: 'app-mainboard-detail-page',
  standalone: true,
  imports: [
    NavbarComponent,
    GalleriaModule,
  ...
  templateUrl: './mainboard-detail-page.component.html',
  styleUrl: './mainboard-detail-page.component.css',
})
export class MainboardDetailPageComponent {
  images: any[] = [];
