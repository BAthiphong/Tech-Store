...
import { Product } from './cooler.models';
import { ActivatedRoute, Router } from '@angular/router';
import { ProductService } from '../services/product.service';
import { CartService } from '../services/cart.service';

@Component({
  selector: 'app-cooler-detail-page',
  standalone: true,
  imports: [
    NavbarComponent,
    GalleriaModule,
  ...
  templateUrl: './cooler-detail-page.component.html',
  styleUrl: './cooler-detail-page.component.css',
})
export class CoolerDetailPageComponent {
  images: any[] = [];
