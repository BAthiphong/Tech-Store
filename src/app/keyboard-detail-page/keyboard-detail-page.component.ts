...
import { Product } from './keyboard.models';
...
@Component({
  ...
  templateUrl: './keyboard-detail-page.component.html',
  styleUrl: './keyboard-detail-page.component.css'
})
export class KeyboardDetailPageComponent {
  images: any[] = [];
