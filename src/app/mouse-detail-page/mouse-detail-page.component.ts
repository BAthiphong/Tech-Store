...
import { Product } from './mouse.models';
import { CartService } from '../services/cart.service';

@Component({
  selector: 'app-mouse-detail-page',
  standalone: true,
  imports: [
    NavbarComponent,
    GalleriaModule,
  ...
  templateUrl: './mouse-detail-page.component.html',
  styleUrl: './mouse-detail-page.component.css',
})
export class MouseDetailPageComponent {
  images: any[] = [];
